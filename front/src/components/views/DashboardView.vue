            ...
            <v-layout row wrap>
              ...
              <v-flex sm6 xs12 md6 lg3>
                <v-card class="ma-3">
                  <v-list-item>
                    <v-list-item-avatar tile class="mt-n7">
                      <v-sheet
                        ...
                        elevation="10"
                      >
                        <v-icon dark large>mdi-shopping</v-icon>
                      </v-sheet>
                    </v-list-item-avatar>
                    <v-list-item-content>
                  ...
                  <v-card-actions>
                    <v-icon text class="ma-2">mdi-ticket-account</v-icon>
              ...
              <v-flex sm6 xs12 md6 lg3>
                <v-card class="ma-3">
                  <v-list-item>
                    <v-list-item-avatar tile class="mt-n7">
                      <v-sheet
                        ...
                        elevation="10"
                      >
                        <v-icon dark large>mdi-contacts</v-icon>
                      </v-sheet>
                    </v-list-item-avatar>
                    <v-list-item-content>
                  ...
                  <v-card-actions>
                    <v-icon text class="ma-2">mdi-folder</v-icon>
...
export default {
  ...
  data() {
    return {
      ...
      team: [
        { name: "SIM HUL", role: "EDUCATION TEAM", avatar: "/img1.png" },
        { name: "RONAN ORGOR", role: "WEB TRAINER", avatar: "/img2.png" },
        { name: "MOK PISET", role: "ERO TEAM", avatar: "/img3.png" },
        {
          name: "SOKHOM HEANG",
          role: "TECHNICAL TEAM",
          avatar: "/img4.png",
